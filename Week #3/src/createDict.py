...
myfinaldict = {}
fileslist = []
for path, subdirs, files in os.walk('C:\\Users\\Asif\\Desktop\\FormalWork2'):
...
doned = 0
errorfiles = open("NoPaths2.txt","w+")
errorstring = ""
...
errorfiles.close()
pickle.dump(myfinaldict, open( "PickledDict2.p", "wb" ))

"""
print(processPage('C:\\Users\\Asif\\Desktop\\FormalWork2\\TPTY;HX.html'))
